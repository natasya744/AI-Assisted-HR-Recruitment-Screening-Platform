SCREENING_ADVISOR_SYSTEM_PROMPT = (
    ...
    "Whether a candidate is a good cultural fit\n"
    "Whether the candidate would accept the offer\n\n"
    "After classifying every requirement, produce two additional output fields:\n\n"
    "concise_summary: A single, clear sentence explaining WHY the candidate\n"
    "is qualified or not qualified, based strictly on verified evidence.\n"
    "Never use vague language. Always state what was confirmed or what is missing.\n\n"
    "Example: \"Meets all mandatory requirements — Python and 3+ years experience\n"
    "verified. One preferred skill (Docker) is missing.\"\n\n"
    "hr_advice: A short, actionable recommendation for HR on the next step.\n"
    "Choose one of:\n\n"
    "\"Proceed to interview\" — every REQUIRED qualification is MATCH.\n"
    "\"Request additional documentation\" — a REQUIRED qualification is\n"
    "NOT_FOUND or PARTIAL_MATCH but could be clarified.\n"
    "\"Reject — missing mandatory requirement(s)\" — a REQUIRED qualification\n"
    "is NOT_MATCH.\n"
    "\"Consider for a different role\" — the candidate lacks required\n"
    "qualifications for this job but has transferable skills.\n\n"
    "The hr_advice must be exactly one sentence and directly reflect the\n"
...
SCREENING_ADVISOR_USER_PROMPT = (
    ...
    "Output a JSON object with overall_classification, concise_summary, hr_advice, "
    "per_requirement assessments, additional_qualifications, and advisor_confidence.\n\n"
    ...
    "- concise_summary and hr_advice MUST be plain strings (or null).\n"

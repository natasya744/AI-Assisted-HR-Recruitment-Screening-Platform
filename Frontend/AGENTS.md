...
This is the React SPA for AI-Assisted HR Recruitment Screening Platform. Read [../AGENTS.md](../AGENTS.md) first — universal building rules live there. This file adds frontend-specific conventions.

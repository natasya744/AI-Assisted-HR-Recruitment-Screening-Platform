    ...
    <div className="space-y-12 py-4">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-indigo-100 bg-gradient-to-b from-indigo-50/70 via-white to-white p-8 sm:p-12 text-center shadow-xs">
        <div className="mx-auto max-w-3xl space-y-4">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">
            Streamlined Recruitment with <span className="bg-gradient-to-r from-indigo-600 to-sky-600 bg-clip-text text-transparent">Explainable AI</span>
          </h1>
      ...
      <div>
        <div className="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-xl font-bold tracking-tight text-slate-900">Platform Portals</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="group flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-xs hover:border-indigo-300 hover:shadow-md transition-all">
            <div className="space-y-4">
              ...
              <h3 className="text-lg font-bold text-slate-900">Apply for Positions</h3>
          ...
          <div className="group flex flex-col justify-between rounded-2xl border border-indigo-200/80 bg-white p-6 shadow-xs hover:border-indigo-400 hover:shadow-md transition-all relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <h3 className="text-lg font-bold text-slate-900">HR Screening Dashboard</h3>
              <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
          ...
          <div className="group flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-xs hover:border-indigo-300 hover:shadow-md transition-all">
            <div className="space-y-4">
              ...
              <h3 className="text-lg font-bold text-slate-900">Create & Manage Jobs</h3>
              <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-xs">
        <div className="mb-6">
          <h2 className="text-lg font-bold text-slate-900">How the Screening Engine Works</h2>
          <p className="text-xs sm:text-sm text-slate-500">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
            ...
            <h4 className="text-sm font-semibold text-slate-900">1. Document Intelligence</h4>
          ...
          <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
            ...
            <h4 className="text-sm font-semibold text-slate-900">2. Deterministic Scoring</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
            ...
            <h4 className="text-sm font-semibold text-slate-900">3. Alignment Verification</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
            ...
            <h4 className="text-sm font-semibold text-slate-900">4. Human Decision</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
